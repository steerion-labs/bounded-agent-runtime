...
2. If the PR adds or changes `.github/skills/**`, `AGENTS.md`, `SECURITY.md`, workflows, CODEOWNERS or other gate definitions, require separate independent review plus Human Gate and never allow the candidate to weaken the accepted-base minimums.
