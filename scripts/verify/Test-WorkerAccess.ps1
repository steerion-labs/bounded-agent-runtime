...
try {
    ...
    Invoke-Probe $ReviewerCredential "try { Set-Content -LiteralPath '$verificationLiteral' -Value bad -ErrorAction Stop; exit 47 } catch { exit 0 }" 0 'Reviewer verification-work write denial'
