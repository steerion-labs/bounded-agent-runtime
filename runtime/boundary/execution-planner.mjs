...
export function createExecutionPlan({ task, registry, capability_id, action, role, agents, providers = [], candidate_sha = null, evidence = [], policy_version = 'boundary-v0.1' }) {
  const authority = decideBoundaryAuthority({ task, registry, capability_id, action, role, evidence });
